    ...
    return(
      <div style={{backgroundColor: '#ffffff'}}>
        ...
        <form className="aform" style={{  backgroundColor: '#f8f361'}}  onSubmit={this.onSubmit.bind(this)}>
            ...
            <div style={{marginTop:60, height: '50px'}}>
              <input className="pt-input" style={{width: "250px",height: '30px'}} placeholder="성명" type="text" dir="auto" onChange={this.onChange.bind(this,'username')}/>
            ...
            <div style={{height: '50px'}}>
              <input className="pt-input" style={{width: "250px",height: '30px'}} placeholder="비밀번호 확인" type="password" dir="auto" onChange={this.onChange.bind(this,'confirm_password')}/>
              {!!this.showError('confirm_password') ? <p className="error-message">{this.getError('confirm_password')} </p> : null}
            </div >
            <button style={{ width: 250,height: '30px'}} type="submit"  class="pt-button pt-intent-primary">가입하기</button>
